           ...
           <div class="card-body">
             <form action="edit-proses.php" method="post">
               <table class="table">
                ...
                <tr>
                   <td>Ringkasan</td>
                   <td style=""><textarea style="width: 100%; height: 100px;" value="<?= $buku['cover']; ?>" type="textarea"
                                 name="ringkasan" required><?= $buku['ringkasan']; ?></textarea></td>
                ...
                <tr>
                   <td>Kategori</td>
                   <td>
                     <select style="width: 100%" name="id_kategori" value="<?= $buku['stok']; ?>" required>
                       option>
                       <?php
                ...
                <tr>
                  <th></th>
                  <th>
                    <button style="width: 100%; height: 70px" type="submit" class="btn btn-primary" name="simpan">EDIT</button>
                  </th>
                </tr>
               </table>
             </form>
